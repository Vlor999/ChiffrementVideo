...
#Pour coder un message, il faut cependant transformer les caractères 
#sous forme de nombres. De plus, on utilisera la méthode de vigenère pour empêcher l'analyse
# des fréquences. 

texte="""j'ai fait un code RSA"""
